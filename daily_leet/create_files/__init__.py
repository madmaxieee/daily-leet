...
def create_files(lang_slug: LangSlugs, title_slug: str, code_snippet: str, example_test_case: str) -> None:
    file_creator_map = {
    ...
    file_creator_map[lang_slug](title_slug, code_snippet, example_test_case)
